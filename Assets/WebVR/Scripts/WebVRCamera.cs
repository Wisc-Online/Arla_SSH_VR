...
public class WebVRCamera : MonoBehaviour
{
    ...
    public GameObject cameraLReticle;
    public GameObject cameraMainReticle;
    ...
    void Update()
    {
        if (vrActive)
        {
            ...
            cameraLReticle.SetActive(true);
            cameraMainReticle.SetActive(false);
        }
        else
        {
            ...
            cameraLReticle.SetActive(false);
            cameraMainReticle.SetActive(true);
        }
